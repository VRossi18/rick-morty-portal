...
function EpisodeCardInner({ episode, interaction = 'normal', onBeforeNavigate }: Props) {
   ...
   return (
      <motion.div
         ...
         className="episode-card-item glow-card group mb-6 cursor-pointer break-inside-avoid outline-none ring-primary focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-color)]"
      >
